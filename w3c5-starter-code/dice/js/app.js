...
function rollDice(dice1, dice2){
	var die1 = document.getElementById("first-die");
	var die2 = document.getElementById("second-die");
	die1.className = dice1
	die2.className = dice2
};

document.getElementById("roll-dice").onclick = function() {
	var random1 = Math.floor(Math.random() * 6) + 1;
	var random2 = Math.floor(Math.random() * 6) + 1;
	var dice1 = "dice-" + random1;
	var dice2 = "dice-" + random2;
